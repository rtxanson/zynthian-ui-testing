...
class zynthian_engine_pianoteq(zynthian_engine):
	...
	# TODO: 70-79 are free
	# TODO: 84-91 are free
	# most of the ones used below stick to expected midi controllers
	_ctrls=[
		# name, controller, default, values
		['volume',7,96],
		['dynamic',85,64],
		['mute',19,'off','off|on'],
	...
	_ctrl_screens=[
		...
		['reverb',['volume','rev on/off','rev duration','rev mix']],
		['reverb type',['volume','room','pre-delay','early reflections']],
		['reverb tone',['volume','rev tone']],
		['design', ['volume', 'resonance']],
	]
